...
Project.create!(user_id: 1, project_manager: "Ben Affleck", name: "Project Eight", deadline: "2023/9/30", description: "This project is about....", priority: "[\"High\"]", capacity: 65, tool_system: tool.sample)
Project.create!(user_id: 1, project_manager: "Terry", name: "", deadline: "2023/10/15", description: "This project is about....", priority: "[\"Medium\"]", capacity: 45, tool_system: tool.sample)
Project.create!(user_id: 1, project_manager: "Loki Millioud", name: "Take a Long Nap", deadline: "2023/9/15", description: "This project is about....", priority: "[\"High\"]", capacity: 65, tool_system: tool.sample)
puts "Created seeds"
